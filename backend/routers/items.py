...
@router.post("/item/", response_model=schemas.ItemBase)
...
@router.get("/item/{item_id}/", response_model=schemas.ItemCardRead)
...
@router.delete("/item/{item_id}", response_model=schemas.ItemCardRead)
